...
INSERT INTO `profiles` VALUES (1,'m','1989-04-09',1,'Hamillfurt','Austria'),(2,'x','1991-11-11',13,'Hamillfurt','Austria'),(3,'f','2000-10-01',NULL,'Camilahaven','Russia'),(4,'f','1977-12-18',NULL,'Osinskibury','USA'),(5,'f','1985-10-14',5,'Raphaellestad','USA'),(6,'x','2006-12-02',17,'Hansenburgh','USA'),(7,'x','2014-12-27',NULL,'Hamillfurt','Russia'),(8,'x','1970-04-06',NULL,'East Carrieborough','Canada'),(9,'x','2020-02-28',9,'Hamillfurt','Canada'),(10,'m','1992-01-27',21,'Hamillfurt','Germany'),(11,'x','2002-04-29',NULL,'West Lenniemouth','France'),(12,'m','1999-10-10',NULL,'Moscow','Russia'),(13,'m','1990-11-11',NULL,'Moscow','Russia'),(14,'m','1990-11-11',NULL,'Moscow','Russia');
...
--
/*!50003 DROP FUNCTION IF EXISTS `func_user_popularity` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `func_user_popularity`(for_user_id BIGINT UNSIGNED) RETURNS float
    READS SQL DATA
BEGIN
	DECLARE cnt_to_user INT;
	DECLARE cnt_from_user INT;
	
	-- Посчитаем кол-во входящих заявок
	SET cnt_to_user = (SELECT COUNT(*) FROM friend_requests WHERE to_user_id = for_user_id);

	-- Посчитаем кол-во исходящих заявок другим способом
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_add_user`(firstname VARCHAR(150), lastname VARCHAR(150), email VARCHAR(150), phone CHAR(11),
							gender CHAR(1), birthday DATE, city VARCHAR(130), country VARCHAR(130),
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_friendship_recomendations` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_friendship_recomendations`(IN for_user_id BIGINT UNSIGNED)
BEGIN
...
WHERE cu1.user_id = for_user_id AND cu2.user_id != for_user_id 
ORDER BY RAND()
LIMIT 5;
END ;;
DELIMITER ;
...
-- Dump completed on 2022-08-02 16:45:16
